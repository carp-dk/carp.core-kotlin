...
extend.$_$.System.prototype.now = function(): kotlinx.datetime.Instant { return this.q14(); };
extend.$_$.Instant_0.prototype.toEpochMilliseconds = function(): bigint { return this.t1k(); };
