...
| `getBatchForStudyDeployments` | Fetch collected data across multiple study deployments with optional filtering by device roles, data types, and time range. | in deployment: (all) `studyDeploymentIds` | |
